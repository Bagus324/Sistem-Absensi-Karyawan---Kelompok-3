...
Public Class Users
    ...
    Public Function addDataUsersDatabase(username_regist As String, password_regist As String, email_regist As String, foto As String)
        Try
            Dim today = Date.Now()
           ...
           + "password=" + password_db + ";" + "database =" + database
            ...
            sqlCommand.Connection = dbConn
            sqlQuery = "INSERT INTO users(username, password, email, foto, registered_at) VALUE('" &
                         username_regist & "', '" &
